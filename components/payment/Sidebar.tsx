...
const Sidebar = () => {
  return (
    <Card className="w-full border-none  max-w-[32%]">
      <div className="sticky rounded-md top-[50px] p-4 shadow-lg">
        <CardTitle className="text-[24px] mb-4 text-primary">
          Price Details
        </CardTitle>
        ...
        <CardContent className="w-full mb-3">
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1" className="w-full">
              <AccordionTrigger className="flex justify-between hover:no-underline">
                ...
                <p className="text-primary font-semibold text-sm">174$</p>
              </AccordionTrigger>
              <AccordionContent className="border-b-0 flex flex-col gap-y-3">
                ...
                >
                  ...
                  <p className="text-[#8592a6] text-sm">$172.50 x 1</p>
                </AccordionItem>
                <AccordionItem
                  value="item-2"
                  className="w-full flex items-center justify-between border-b-0"
          ...
          <div className="mt-6 w-full">
            <h4 className="mb-3 text-primary font-semibold text-[14px]">
              Baggage
            </h4>
            <PaymentModal />
          </div>
        ...
        <CardFooter className="w-full flex items-start justify-between">
          <h4 className="text-primary font-semibold text-[20px]">Total</h4>
          <span className="flex flex-col gap-y-2 items-end">
            <b className="text-primary/85 text-[20px]">$172.50</b>
