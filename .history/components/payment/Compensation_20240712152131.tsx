    ...
    <Card className='mt-8'>
        <CardHeader>
            <div>
                ...
                <p className='text-[#8592a6] text-[13px]'>Worried your flight(s) could be delayed or canceled? AirHelp supports you 24/7 and helps you claim the compensation you're entitled to afterwards.</p>
            </div>
