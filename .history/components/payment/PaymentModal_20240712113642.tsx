          ...
          <div id="flightCancellation">
            ...
            <div className="mt-6">
              ...
              <div>
                ...
                <p>When date/time changes result in a new ticket price which is higher than the original ticket price, the difference must be paid. According to the airline's policy, once a ticket has been changed, the change fee that has already been paid is non-refundable if any further changes are made.</p>
              </div>
            </div>
          </div>
        </div>
