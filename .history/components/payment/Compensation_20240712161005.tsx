    ...
    <div className="w-full h-[400px] max-w-5xl mx-auto p-4 shadow-md">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-white  rounded-lg overflow-hidden">
        <div className="flex flex-col p-4">
          <ul>
            <li className="mb-2 text-[14px] text-[#]">Up to €6,000.00 (approx. $6,531.00) for additional expenses (lost baggage or missed hotel bookings)</li>
            <li className="mb-2 text-[14px] text-[#]">24/7 live chat support from AirHelp</li>
            <li className="mb-2 text-[14px] text-[#]">AirHelp's specialists handle the entire process of getting your compensation</li>
            <li className="mb-2 text-[14px] text-[#]">Access to a VIP lounge if your flight is delayed by more than 1 hour or canceled less than 6 hours before departure.</li>
          </ul>
