            ...
            <div>
                ...
                <ul>
                    <li>
                      ...
                      <span className='text-[#0f294d] text-[14px] flex'>Trip Cancellation and Interruption Coverage - up to <p className='text-[#06aebd]'> 100% of trip cost (max. $10,000 per person)</p></span>
                    </li>
                </ul>
            </div>
        </CardContent>
