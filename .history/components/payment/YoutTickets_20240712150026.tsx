...
const YoutTickets = () => {
  return (
    <>
      ...
      <ul className="flex items-center justify-between bg-slate-200 mt-8">
        <li className="flex items-center rounded-md gap-x-4 border-[1px] border-[#0f294d] p-4">
            ...
            <span>
                ...
                <p className="text-[rgb(133, 146, 166)]">Once payment is confirmed, tickets will be issued within 2 days.</p>
            </span>
        </li>
      </ul>
    </>
