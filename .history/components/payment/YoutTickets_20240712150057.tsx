...
const YoutTickets = () => {
  return (
    <>
      ...
      <ul className="flex items-center justify-between bg-slate-100 mt-8">
        <li className="flex items-center rounded-md gap-x-4 border-[1px] border-[#0f294d] p-4">
            <SquarePercent />
            <span>
                <h3 className="text-[#0f294d] font-bold">Ticket Issuing Time</h3>
                <p className="text-[#8592a6] text-[12px]">Once payment is confirmed, tickets will be issued within 2 days.</p>
            </span>
        </li>
      </ul>
    </>
