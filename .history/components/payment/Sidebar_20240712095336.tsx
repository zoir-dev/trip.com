  ...
  return (
    <Card className="w-full max-w-[32%] p-4 shadow-xl">
      ...
      <CardFooter  className="w-full flex items-start justify-between">
        <h4 className="text-[#0f294d] font-semibold text-[18px]">Total</h4>
        <span className="flex flex-col items-end">
            <b className="text-[hsl(225.36585365853657, 100%, 59.80392156862745%)] text-[18px]">$172.50</b>
            <button>Trip Coins +44</button>
        </span>
      </CardFooter>
    </Card>
  );
