...
export function PaymentModal() {
  return (
    <Sheet>
      ...
      <SheetContent side="right" className="w-[50%] overflow-auto scroll-smooth">
        ...
        <div className="flex flex-col gap-y-6">
         ...
         <div className="border-[1px] shadow-md border-gray-300 rounded-lg p-4">
            <p className="text-[#0f294d] font-medium text-[14px]">The ticket policy is subject to the rules listed below, and these might differ from policies listed on the airline's website. Any cancellation or change requests must be made through Trip.com platforms or to our customer support.</p>
         </div>

         <div>
            <h4 className="text-[#0f294d] font-medium text-[14px]">Cancellation Fee(Price per passenger)</h4>
            <Table>
