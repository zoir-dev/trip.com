    ...
    <Card>
      ...
      <CardContent>
        <div>
          <span className="flex items-center justify-between">
            ...
            <span className="flex items-center gap-x-2">
              ...
              <input type="checkbox" name="travel" className="form-radio" />
            </span>
          </span>
        ...
        <div className="flex justify-between">
           <span>
            <h4>No Protection</h4>
            <p>I understand the risks of traveling without insurance</p>

            <p>You won't be able to add insurance once your booking is complete</p>
           </span>
