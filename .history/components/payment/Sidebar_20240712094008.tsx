      ...
      <CardContent className="w-full">
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1" className="w-full">
            ...
            <AccordionContent>
              <AccordionItem value="item-2" className="w-full flex items-center justify-between">
                <p className="text-[#8592a6] text-[14px]">Adults (SHAXZOD ESHIMOV)</p>
                <p className="">$172.50 x 1</p>
              </AccordionItem>
            </AccordionContent>
          </AccordionItem>
        </Accordion>
