...
const PlanSelection = () => {
  ...
  return (
    <div className="w-full h-[400px]  max-w-5xl mx-auto p-4 mb-8 shadow-md">
        ...
        <div className="flex h-full gap-x-1 w-full md:w-3/3">
          {plans.map((plan, index) => (
            ...
            >
              ...
              <p className="text-[15px] mb-8 whitespace-nowrap font-semibold">{plan.name}</p>
              <div className="mt-4">
                {plan.benefits.map((benefit, i) => (
                    <div key={i} className="flex items-center gap-y-6">
