    ...
    <Sheet>
      ...
      <SheetContent side="right" className="w-[50%]">
        ...
        <div className="flex flex-col gap-y-6">
            ...
            <div id="bookingInformation">
                <SheetTitle className="mb-1 text-[#0f294d]">Baggage Allowance</SheetTitle>
                <p className="text-[#8592a6] mb-5 font-medium text-[14px]">The total weight of the personal item and carry-on baggage cannot exceed 10 kg</p>
                <ul className="flex flex-col border-[1px] border-gray-300 shadow-lg rounded-lg">
                    <li className="flex gap-x-3 p-4 rounded-[6px]">
                    <Luggage className="text-[#05939f]" />
                        <span>
                            <h4 className="text-[#0f294d] font-semibold mb-2">Frequent Flyer Miles</h4>
                            <p className="text-[#0f294d] font-medium text-[14px]">1 piece per person.</p>
                            <p className="text-[#0f294d] font-medium text-[14px]">Must be placed under the seat in front of you</p>
                        </span>
                    </li>
