          ...
          <div id="flightCancellation">
            ...
            <div className="mt-6">
              ...
              <Table className="mt-3 w-full">
                ...
                <TableHeader className="w-full">
                  <TableRow>
                    <TableHead className="w-[50%] font-bold text-[#0f294d]">Request Time</TableHead>
                    <TableHead className="w-[50%] font-bold text-[#0f294d]">Adult Tickets</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {invoices.map((invoice) => (
