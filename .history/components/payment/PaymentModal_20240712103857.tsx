      ...
      <SheetContent side="right" className="w-[50%]">
        ...
        <div>
            <div id="bookingInformation">
                ...
                <ul className="border-[1px] border-gray-300 shadow-lg rounded-lg">
                    ...
                    <Check className="text-[#05939f]" />
                        <span>
                            ...
                            <p className="text-[#0f294d] font-bold text-[14px]">Passengers with a standard frequent flyer membership will earn approximately 634 miles/points. </p>
