            ...
            <div className="mt-6">
              <ul className="flex flex-col gap-y-3">
                <li className="flex items-center gap-x-8">
                  <span>10:30</span>
                  <h4 className="text-[#0f294d] font-bold">ICN Seoul Incheon International AirportT2</h4>
                </li>
                <li className="flex items-center gap-x-8">
                 <Image width={16} height={16} className="w-[16px] h-[16px]" src="https://static.tripcdn.com/packages/flight/airline-logo/latest/airline_logo/3x/ke.webp" alt="" />
                  <h4>ICN Seoul Incheon International AirportT2</h4>
                </li>
                <li className="flex items-center gap-x-8">
                  <span>12:10</span>
                  <h4  className="text-[#0f294d] font-bold">TPE Taipei Taiwan Taoyuan International AirportT1</h4>
                </li>
              </ul>
            </div>
